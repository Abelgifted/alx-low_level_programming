 ...
 * @e_ident: Points to an array containing the ELF magic nums.
 *
...
/**
 * print_magic - Prints magic nums of an ELF header.
 * @e_ident: Points to an array containing the ELF magic nums.
 *
 * Description: The magic nums are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
int index;
...
/**
 * main - Displays information containing the
...
w = read(o, header, sizeof(Elf64_Ehdr));
if (w == -1)
{
free(header);
close_elf(o);
